...
function InsertProject({emptyEmployee,add,setAdd}) {
    ...
    useEffect(() => {
        var edict = {};
            for(let i=0;i<emptyEmployee.length;i++)
                edict[emptyEmployee[i]]=1;
            setEstate(edict);
        ...
        <div className="emp-wrapper">
            ...
            <div className="content-wrapper">
                <div className="drop-wrapper" style={{marginTop:'16px'}}>
                    ...
                    <select className="h5 modify-dropdown" id="modify-dropdown-1" onChange ={(e) => setLeader(e.target.value)} >
                ...
                <div className="field-wrapper">
                    ...
                    <input type="text" className="modify-input-field" name = 'projectName' onChange={insertLogger}/>
                </div>
                <div className="field-wrapper">
                    <p className="p1">Budget</p>
                    <input type="text" className="modify-input-field" name = 'budget' onChange={insertLogger}/>
                </div>
                <div className="field-wrapper">
                    <p className="p1">Project Description</p>
                    <textarea rows={4} className="address p1 address-text field" name = 'descrption' style={{border:'1px solid var(--neutral-300)',
                borderRadius:'8px',
                width:'672px',
                marginTop:'8px',
                backgroundColor: 'var(--white)'}} onChange={insertLogger} ></textarea>
                </div>
            </div>
